...
public:
	Status_box() {}
	Status_box(int pos_x_1, int pos_y_1, int pos_x_2, int pos_y_2, Street* street, int button_id, ALLEGRO_BITMAP *info_image, int pos_x_displacement = 0, int pos_y_displacement = 0) : pos_x_1(pos_x_1), pos_x_2(pos_x_2), pos_y_1(pos_y_1), pos_y_2(pos_y_2), pos_x_displacement(pos_x_displacement), pos_y_displacement(pos_y_displacement), color_r(255), color_g(0), color_b(0), active(false) {
	}
