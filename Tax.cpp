...
Tax::Tax(int pos_x_1, int pos_x_2, int pos_y_1, int pos_y_2, int pos_ruta, std::string namn, int typ, int fee) : Property(pos_x_1, pos_x_2, pos_y_1, pos_y_2, pos_ruta, namn, typ), fee(fee), choose(0) {
	//constructor
	if(pos_ruta == 4)
		temp_buttons = new Button*[2];
}

void Tax::create_income_tax_question(int pos_x_in, int pos_y_in, ALLEGRO_BITMAP* button, ALLEGRO_BITMAP* question){
	if(pos_ruta == 4){
...
void Tax::pay_fee(Player* visitor, Property** tomter){
